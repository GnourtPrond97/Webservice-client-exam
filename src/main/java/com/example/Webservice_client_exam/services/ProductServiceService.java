 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "http://service.stringbootws.example.com/", wsdlLocation = "http://localhost:8088/ws/product?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("http://service.stringbootws.example.com/", "ProductServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/ws/product?wsdl");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://service.stringbootws.example.com/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.stringbootws.example.com/", "ProductServicePort"), ProductService.class, features);
    }
